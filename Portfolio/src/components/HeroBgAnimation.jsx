...
const HeroBgAnimation = () => (
  <div className="absolute left-1/2 -translate-x-1/2 sm:-right-28 sm:left-auto sm:translate-x-0 top-1/2 -translate-y-1/2 w-[520px] h-80 sm:w-[500px] sm:h-[500px] lg:w-[600px] lg:h-[600px]">
    <svg
